...
except ModuleNotFoundError:  # fallback if environs isn't installed
    # If environs isn't available, use django-environ package if installed.
    from environs import Env
import os
env = Env()
env.read_env()
...
# Use Django's default User model unless you have an `api` app.
...
FLUTTERWAVE_PRIVATE_KEY_LIVE = env("FLUTTERWAVE_PRIVATE_KEY_LIVE", default="")
FLUTTERWAVE_ENCRYPTION_KEY = env("FLUTTERWAVE_ENCRYPTION_KEY", default="")

RAVE_PUBLIC_KEY = env("RAVE_PUBLIC_KEY", default="")
RAVE_SECRET_KEY = env("RAVE_SECRET_KEY", default="")
